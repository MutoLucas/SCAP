<div class="container mt-4 p-2">
    ...
    <div class="w-full d-flex justify-around gap-3">
        ...
        <div class="border border-light-subtle rounded-2 w-100 p-3 shadow-lg">
            <div class="w-50">
    ...
    @if (auth()->check())
        <div class="w-full mt-2 d-flex justify-content-end">
            <button class="btn btn-outline-success" type="button" wire:click="saveAlters"><i class="bi bi-upload"></i>
                Salvar</button>
        </div>
    @endif
