        ...
        <div class="border border-light-subtle rounded-2 w-50 p-3 shadow-lg">
            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <div class="p-1">
                    ...
                    <select class="form-select form-select-sm  border-primary" wire:model.lazy="tagGerador" @disabled(!auth()->check())>
        ...
        <div class="border border-light-subtle rounded-2 w-50 p-3 shadow-lg">
            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <div class="p-1">
                    ...
                    <select class="form-select form-select-sm  border-primary" wire:model.lazy="processo" @disabled(true)>
                        <option value="">Selecione...</option>
                ...
                <div class="p-1">
                    ...
                    <select class="form-select form-select-sm  border-primary" wire:model.lazy="sistema" @disabled(true)>
                        <option value="">Selecione...</option>
                ...
                <div class="p-1">
                    ...
                    <select class="form-select form-select-sm  border-primary" wire:model.lazy="equipamento" @disabled(true)>
                        <option value="">Selecione...</option>
                        @foreach ($this->equipamentos as $equipamento)
                ...
                <div class="p-1">
                    ...
                    <input type="datetime-local" class="form-control border-primary" wire:model.lazy="inicio" @disabled(true)>
                    @error('Inicio')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="p-1">
                    ...
                    <input type="datetime-local" class="form-control border-primary" wire:model.lazy="fim" @disabled(true)>
                </div>
