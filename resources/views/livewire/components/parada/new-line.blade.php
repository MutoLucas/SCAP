<div class="container mt-4 p-2">
    ...
    <div class="w-full mt-3">
        ...
        <div class="border border-light-subtle rounded-2 w-full p-3 shadow-lg">
            ...
            <div class="">
                ...
                <textarea wire:model="observacao" cols="30" rows="6" class="form-control border-primary"></textarea>
    ...
    <div class="w-full mt-2 d-flex justify-content-end">
        <button class="btn btn-outline-success" type="button" wire:click="storeNewLine"><i
